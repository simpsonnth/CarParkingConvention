...
class PublicRoutesList extends Component
{
    ...
    public function routeEntries(): array
    {
        $definitions = [
            ...
            ['route' => 'management.parking-incidents', 'params' => [], 'label_key' => 'routes_list.row_parking_incidents'],
            ['route' => 'management.toolbox-feedback', 'params' => [], 'label_key' => 'routes_list.row_toolbox_feedback'],
            ['route' => 'management.lessons-learned', 'params' => [], 'label_key' => 'routes_list.row_lessons_learned'],
