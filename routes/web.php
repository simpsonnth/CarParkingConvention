...
Route::get('/scan/{code?}', App\Livewire\Attendant\Scan::class)->name('attendant.scan');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/congregations/{congregation:uuid}/print', function (App\Models\Congregation $congregation) {
